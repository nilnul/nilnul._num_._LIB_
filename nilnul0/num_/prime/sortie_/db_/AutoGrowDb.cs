...
namespace nilnul.num_.plural_.prime.set_
{
	/// <summary>
	/// 
	/// </summary>
	...
	static public partial class AutoGrowDb
	{
		...
		static public readonly  nilnul._num_._LINQ_.eg_.plural_.prime_.db_.l2s_.DataClasses1DataContext db = new _num_._LINQ_.eg_.plural_.prime_.db_.l2s_.DataClasses1DataContext();
		...
		static public bool Contains(long i)
		{
			...
			return db.Primes.Any(c => c.prime1 == i);
		...
		static public bool _Contains(long _plural)
		{
			...
			return db.Primes.Any(c => c.prime1 == _plural);
		...
		static public IEnumerable<long> SequenceUpTo_inLong(long _plural)
		{
			...
			return db.Primes.Where(c => c.prime1 <= _plural).OrderBy(c => c.position).Select(c => c.prime1);
		}
		...
		static public _num_._LINQ_.eg_.plural_.prime_.db_.l2s_.Prime GetMaxRecord_byCheckNull()
		{

			if (db.Primes.Any())
			{
				var t = db.Maxes.FirstOrDefault();
				...
				var prime = new _num_._LINQ_.eg_.plural_.prime_.db_.l2s_.Prime();
		...
		static public _num_._LINQ_.eg_.plural_.prime_.db_.l2s_.Max GetMaxRecord2()
		{


			return db.Maxes.FirstOrDefault();
		...
		static private bool _isNextPrime2(long _plural)
		{
			...
			foreach (var item in 
				...
				db.Primes.Local.Union(

						db.Primes.Where(f => f.prime1 <= sqrtFloor)
						).Select(g => g.prime1)
		...
		static private void _Insert(long sn, long prime)
		{
			...
			var rec = new _num_._LINQ_.model.Prime();
		...
		static private void _SetBound(long newBound)
		{
			...
			compositeUppoerBound = new _num_._LINQ_.model.CompositeCap();
