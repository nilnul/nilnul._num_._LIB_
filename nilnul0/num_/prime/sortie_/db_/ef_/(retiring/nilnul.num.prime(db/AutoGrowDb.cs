...
namespace nilnul.num.prime
{
	...
	static public partial class AutoGrowDb
	{
		public const long MAX = long.MaxValue;

		static public readonly _num_._LINQ_.eg_.plural_.prime_.db_.ef_.Model1 db = new _num_._LINQ_.eg_.plural_.prime_.db_.ef_.Model1();// _linq.Db.CreateConnection();




		static public void _PopulateAndCommit(BigInteger bound_plural_long)
		{
			_PopulateAndCommit((long)bound_plural_long);
		}
		...
		static public IEnumerable<long> _GetRange(long lowerInclusive, long _upperInclusive_positive)
		{
			if (_upperInclusive_positive==1)
			{
				return new long[0];
			}

			_PopulateAndCommit(_upperInclusive_positive);

			return db.Prime.Where(c => c.prime1 <= _upperInclusive_positive && c.prime1>=lowerInclusive).OrderBy(c => c.position).Select(c => c.prime1);
		}

		static public IEnumerable<long> _GetRange(long lowerInclusive_positive)
		{
			
			return _GetRange(lowerInclusive_positive, MAX);
		}
		...
		static public _num_._LINQ_.eg_.plural_.prime_.db_.ef_.Prime GetMaxRecord_byCheckNull()
		{
			...
			if (db.Prime.Any())
			{
				...
				var prime = new _num_._LINQ_.eg_.plural_.prime_.db_.ef_.Prime();
		...
		static public _num_._LINQ_.eg_.plural_.prime_.db_.ef_.Max GetMaxRecord2()
		{
		...
		static private void _Insert(long sn, long prime)
		{
			...
			var rec = new _num_._LINQ_.eg_.plural_.prime_.db_.ef_.Prime();
		...
		static private void _PopulateToCover_saveByBatch(long currentPrimeSn, long currentBound, long newBound,int batchSize=100)
		{
			//long sn = 0;
		...
		static private void _SetBound(long newBound)
		{
			...
			compositeUppoerBound = new _num_._LINQ_.eg_.plural_.prime_.db_.ef_.Cap();
