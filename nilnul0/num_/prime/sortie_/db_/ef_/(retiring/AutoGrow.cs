...
namespace nilnul.num_.plural_.prime.set_.db_.ef
{
	...
	static public partial class AutoGrowDb
	{
		...
		static private bool _isNextPrime2(long _plural)
		{
			...
			var added1unsaved = db.ChangeTracker.Entries()
   .Where(x => x.State == EntityState.Added && x.Entity is nilnul._num_._LINQ_.eg_.plural_.prime_.db_.ef_.Prime t)
   .Select(x => x.Entity as nilnul._num_._LINQ_.eg_.plural_.prime_.db_.ef_.Prime);
