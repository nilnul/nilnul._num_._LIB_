...
namespace nilnul.num.stream
{
	...
	public partial class Fobonacci : StreamA
	{
		BigInteger _small = -1;
		BigInteger _big = 1;

		public override Natural.Asserted next()
		{

			var nextOne = _small + _big;
			_small =_big;

			_big = nextOne;
			return new N(nextOne);
...
/// </remarks>
		...
		static public ulong Item_byMatrixPow(uint index)
		{
			...
			var m = nilnul.num.matrix.square.PowX._Eval_recurBase0_(InitMatrix, index);
			return m[0, 1];
